...
public class CheapItems extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ItemStack categoryItem = new CustomItem(Material.GRASS, "&4Cheap Items", "", "&aClick to get cheap items");
        ...
        SlimefunItem cheapQuartz = new SlimefunItem(category, cheapQuartzStack, RecipeType.HEATED_PRESSURE_CHAMBER,
                recipeinSlimeItem);
